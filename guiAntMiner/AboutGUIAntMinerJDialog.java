	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				this.getContentPane().add(
					...
					new GridBagConstraints(
						...
						0,
						0));
				jLabel5.setIcon(new ImageIcon(getClass().getClassLoader().getResource("udesc_joinville.png")));
			...
			}
			{
				...
				this.getContentPane().add(
					...
					new GridBagConstraints(
						...
						0,
						0));
				jButton2.setText("<html><a href=\"http://www.joinville.udesc.br\">http://www.joinville.udesc.br</a></html>");
				...
				jButton2.setToolTipText("Website of the State University of Santa Catarina, campus Joinville. Available in Portuguese only.");
			...
			}
			{
				...
				{
					jLabel4 = new JLabel();
					jPanel2.add(jLabel4, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
					jLabel4.setText("Copyright Notice");
					jLabel4.setFont(new java.awt.Font("Tahoma",1,11));
				}
				{
					jTextPane1 = new JTextPane();
					jPanel2.add(jTextPane1, new GridBagConstraints(
						0,
						1,
						1,
						1,
						...
						0,
						0));
					jTextPane1.setText("This software is freely available for research and teaching. It is not meant for commercial purposes. If you publish any material involving the use of this software, please quote the original paper that describes the algorithm in detail, as suggested below:");
				...
				}
				{
					...
					jPanel2.add(jTextPane2, new GridBagConstraints(
						0,
						2,
						1,
						1,
						...
						0,
						0));
					jTextPane2.setText("Parpinelli, R.S., Lopes, H.S., Freitas, A.A. \"Data mining with an ant colony optimization algorithm\". IEEE Transactions on Evolutionary Computation, special issue on Ant Colony Algorithms, v. 6, n. 4, p. 321-332, August, 2002.");
				...
				}
				{
					...
					jPanel2.add(jTextPane3, new GridBagConstraints(
						0,
						3,
						1,
						1,
						...
						0,
						0));
					jTextPane3.setText("We do not take any responsibility for the results that you obtain with this software, we do not offer any guarantees, nor do we help with the maintenance of this program.");
			...
			}
			{
				...
				this.getContentPane().add(
					...
					new GridBagConstraints(
						...
						0,
						0));
				jLabel3.setText("Developed by Fernando Meyer under the orientation of Rafael Stubs Parpinelli.");
			}
