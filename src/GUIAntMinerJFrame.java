...
public class GUIAntMinerJFrame extends javax.swing.JFrame {
	...
	*/
	...
	private void initGUI() {
		...
		jTabbedPane1.setBorder(BorderFactory.createEtchedBorder(BevelBorder.LOWERED));
		{
			...
			jPanel8.setBorder(BorderFactory.createEtchedBorder(BevelBorder.LOWERED));
			{
				...
				jPanel8.add(jProgressBar1, new GridBagConstraints(
					1,
					0,
					1,
					1,
			...
			{
				jLabel17 = new JLabel();
				jPanel8.add(jLabel17, new GridBagConstraints(
					0,
					0,
					1,
					1,
		...
		rowSM.addListSelectionListener(new ListSelectionListener() {
		    public void valueChanged(ListSelectionEvent e) {
		        ...
		        if (lsm.isSelectionEmpty()) {
		            ...
		            jLabel10.setText(String.valueOf(calculateMissing(selectedRow))+ " ("+myFormatter.format(((float) calculateMissing(selectedRow)/myFileReader.getDataInstancesArray().length)*100)+"%)");
	...
	public void setTableAtt2(int attributeIndex, int [] typesOccurences){
		...
		jTable2Model = new MyTableModel(
			labelAndCount,
			new String[] { "Attribute Value", "Quantity of Instances" });
		jTable2 = new JTable();
	...
	*/
	...
	/**
	 * Determines the number of occurences of the attribute values in the dataset
	 * @param attributePos
	 * @return
	 */
